...
**Version:** v7.3.2 &nbsp;|&nbsp; **Last updated:** 2026-07-23 (v7.3.2 — bin/tjp-test-local + tier-0 fixtures; fixed psoma/bulkrnaseq silently never writing software_versions.txt)
...
- Sections for every release from v2.0.0 through v7.3.2, plus an `[Unreleased]` section
