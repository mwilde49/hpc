...
```
=== Launching addone pipeline ===

[INFO]  Validating config: /work/jsmith/pipelines/addone/config.yaml
[INFO]  Config validation passed.
[INFO]  Run directory: /work/jsmith/pipelines/addone/runs/2026-03-04_14-30-00

=== Job submitted ===

  Pipeline:   addone
  Job ID:     123456
  Run dir:    /work/jsmith/pipelines/addone/runs/2026-03-04_14-30-00/
  Monitor:    tail -f /work/jsmith/pipelines/addone/runs/2026-03-04_14-30-00/slurm_123456.out
  Cancel:     scancel 123456
```
...
├── config.yaml                    ← simplified YAML (you edit this)
...
```json
{
    ...
    "pipeline": "addone",
    "git_commit": "fc20314",
    "container_file": "/groups/tprice/pipelines/containers/addone_latest.sif",
    "container_checksum": "a1b2c3d4e5f6...",
    "config": "config.yaml",
    "slurm_job_id": "123456",
    "slurm_template": "/groups/tprice/pipelines/slurm_templates/addone_slurm_template.sh",
    "input_paths": "/groups/tprice/pipelines/test_data/numbers.txt",
    "output_paths": "/scratch/juno/jsmith/addone_output.txt"
}
```
...
A: Wherever your config specifies (typically on scratch). The run directory holds only metadata and logs, not pipeline output data.
