...
YAML
    ...
    ts_assert_contains "l2: spaceranger template sources provenance.sh" \
        "$REPO_ROOT/slurm_templates/spaceranger_slurm_template.sh" "provenance.sh"
    ts_assert_contains "l2: spaceranger template captures software versions" \
        "$REPO_ROOT/slurm_templates/spaceranger_slurm_template.sh" "capture_software_versions"
    ts_assert_contains "l2: spaceranger template generates provenance README on exit" \
        "$REPO_ROOT/slurm_templates/spaceranger_slurm_template.sh" "generate_provenance_readme"
...
l3_validate_spaceranger() {
    ...
    ts_assert_exists   "spaceranger: CONSOLE_LOG.txt"       "$work_run/CONSOLE_LOG.txt"
    ts_assert_nonempty "spaceranger: CONSOLE_LOG.txt"       "$work_run/CONSOLE_LOG.txt"
    ts_assert_exists   "spaceranger: software_versions.txt" "$work_run/software_versions.txt"
    ts_assert_contains "spaceranger: software_versions.txt has spaceranger entry" \
                       "$work_run/software_versions.txt" "spaceranger:"
    ts_assert_exists   "spaceranger: PROVENANCE_README.md" "$work_run/PROVENANCE_README.md"
    ts_assert_nonempty "spaceranger: PROVENANCE_README.md" "$work_run/PROVENANCE_README.md"
}
