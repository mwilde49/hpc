...
YAML
    ...
    ts_assert_contains "l2: cellranger-multi template sources provenance.sh" \
        "$REPO_ROOT/slurm_templates/cellranger_multi_slurm_template.sh" "provenance.sh"
    ts_assert_contains "l2: cellranger-multi template captures software versions" \
        "$REPO_ROOT/slurm_templates/cellranger_multi_slurm_template.sh" "capture_software_versions"
    ts_assert_contains "l2: cellranger-multi template generates provenance README on exit" \
        "$REPO_ROOT/slurm_templates/cellranger_multi_slurm_template.sh" "generate_provenance_readme"
...
l3_validate_cellranger_multi() {
    ...
    ts_assert_exists   "cellranger-multi: CONSOLE_LOG.txt"       "$work_run/CONSOLE_LOG.txt"
    ts_assert_nonempty "cellranger-multi: CONSOLE_LOG.txt"       "$work_run/CONSOLE_LOG.txt"
    ts_assert_exists   "cellranger-multi: software_versions.txt" "$work_run/software_versions.txt"
    ts_assert_contains "cellranger-multi: software_versions.txt has cellranger entry" \
                       "$work_run/software_versions.txt" "cellranger:"
    ts_assert_exists   "cellranger-multi: PROVENANCE_README.md" "$work_run/PROVENANCE_README.md"
    ts_assert_nonempty "cellranger-multi: PROVENANCE_README.md" "$work_run/PROVENANCE_README.md"
}
